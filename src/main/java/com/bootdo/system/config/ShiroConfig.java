...
public class ShiroConfig {
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/getBackSmsVerify","anon");
        filterChainDefinitionMap.put("/register","anon");
        filterChainDefinitionMap.put("/getSmsVerify","anon");
        filterChainDefinitionMap.put("/backpass","anon");
        ...
        filterChainDefinitionMap.put("/signature/install/**", "anon");
        filterChainDefinitionMap.put("/signature/udid/**", "anon");
