...
CREATE TABLE `download_log` (
  `id` int(15) NOT NULL AUTO_INCREMENT,
  `download_time` bigint(15) DEFAULT NULL,
  `udid` varchar(255) DEFAULT NULL,
  `app_id` int(15) DEFAULT NULL,
  `user_id` int(15) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=834 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for enterprise_package
-- ----------------------------
DROP TABLE IF EXISTS `enterprise_package`;
CREATE TABLE `enterprise_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `app_id` int(11) DEFAULT NULL COMMENT 'appId',
  `url` varchar(255) DEFAULT NULL COMMENT '签名包地址',
  `status` int(1) DEFAULT NULL COMMENT '1:待签名2:签名完成',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for original_application
-- ----------------------------
DROP TABLE IF EXISTS `original_application`;
CREATE TABLE `original_application` (
  ...
  `show_icon_url` varchar(255) DEFAULT NULL,
  `show_app_name` varchar(255) DEFAULT NULL,
  `short_domain` varchar(255) DEFAULT NULL,
  `screenshots` varchar(255) DEFAULT NULL,
  `push` bit(1) DEFAULT b'1',
  `quota` int(10) DEFAULT '-1',
  `app_type` int(1) DEFAULT NULL COMMENT '应用类型(1:个人签|2:企业签|3:安卓)',
  `file_url` varchar(255) DEFAULT NULL,
  `udid_title` varchar(255) DEFAULT NULL COMMENT 'UDID标题',
  `udid_description` varchar(255) DEFAULT NULL COMMENT 'UDID描述',
  `download_num` int(10) DEFAULT '0' COMMENT '下載數量',
  PRIMARY KEY (`app_id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of original_application
-- ----------------------------
...
CREATE TABLE `pay_order` (
  `rid` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '流水号',
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '-1非法，0默认，1为创建订单成功，2为创建订单成功但第三方创建失败，3为支付完成',
  `otherid` varchar(255) DEFAULT NULL COMMENT '第三方订单号',
  `price` decimal(11,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '价格',
  `num` int(11) NOT NULL DEFAULT '0' COMMENT '数量',
  `remark` varchar(30) DEFAULT '' COMMENT '备注',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建订单时间',
  `mtime` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单状态更新时间',
  PRIMARY KEY (`rid`),
...
) ENGINE=InnoDB AUTO_INCREMENT=17172 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `recharge_log` (
  ...
  `create_time` bigint(15) DEFAULT NULL,
  `creater_id` int(15) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
-- Table structure for service_contact
-- ----------------------------
DROP TABLE IF EXISTS `service_contact`;
CREATE TABLE `service_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(20) DEFAULT NULL COMMENT '微信1|QQ2',
  `value` varchar(255) DEFAULT NULL COMMENT '号码',
  `main` int(1) DEFAULT NULL COMMENT '联系客服(是:1 否:0)',
  `pos` int(1) DEFAULT NULL COMMENT '显示位置(1:右边2:底部)',
  `img` varchar(255) DEFAULT '' COMMENT '图片URL',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for signature_package
-- ----------------------------
DROP TABLE IF EXISTS `signature_package`;
CREATE TABLE `signature_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `udid` varchar(255) DEFAULT NULL,
  `app_id` int(15) DEFAULT NULL,
  `file_url` varchar(255) DEFAULT NULL,
...
INSERT INTO `sys_dept` VALUES ('13', '0', '客户', '5', '1');
...
CREATE TABLE `sys_file` (
  ...
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='文件上传';
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2783 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', '0', '基础管理', '', '', '0', 'fa fa-bars', '7', '2017-08-09 22:49:47', null);
INSERT INTO `sys_menu` VALUES ('2', '3', '系统菜单', 'sys/menu/', 'sys:menu:menu', '1', 'fa fa-th-list', '2', '2017-08-09 22:55:15', null);
INSERT INTO `sys_menu` VALUES ('3', '0', '系统管理', '', '', '0', 'fa fa-desktop', '8', '2017-08-09 23:06:55', '2017-08-14 14:13:43');
...
INSERT INTO `sys_menu` VALUES ('77', '0', '系统工具', '', '', '0', 'fa fa-gear', '10', null, null);
...
INSERT INTO `sys_menu` VALUES ('91', '0', '系统监控', '', '', '0', 'fa fa-video-camera', '9', null, null);
INSERT INTO `sys_menu` VALUES ('92', '91', '在线用户', 'sys/online', '', '1', 'fa fa-user', null, null, null);
INSERT INTO `sys_menu` VALUES ('97', '0', '图表管理', '', '', '0', 'fa fa-bar-chart', '11', null, null);
INSERT INTO `sys_menu` VALUES ('98', '97', '百度chart', '/chart/graph_echarts.html', '', '1', 'fa fa-area-chart', null, null, null);
INSERT INTO `sys_menu` VALUES ('99', '0', '可安装数', '', '', '0', 'fa fa-barcode', '4', null, null);
INSERT INTO `sys_menu` VALUES ('100', '99', '添加次数', '/signature/recharge/add', 'sig:recharge:add', '1', 'fa fa-plus-circle', null, null, null);
INSERT INTO `sys_menu` VALUES ('101', '99', '用户统计', '/signature/statistics/allusers/surplus', 'sig:stat:all:surplus', '1', 'fa fa-bar-chart-o', null, null, null);
INSERT INTO `sys_menu` VALUES ('102', '0', '苹果账号管理', '', '', '0', 'fa fa-gears', '6', null, null);
INSERT INTO `sys_menu` VALUES ('103', '102', '账号管理', '/signature/account/index', 'sig:account:index', '1', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('104', '102', '账号列表', '/signature/account/list', 'sig:account:list', '2', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('105', '102', '添加账号', '/signature/account/add', 'sig:account:add', '2', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('106', '102', '账号启用', '/signature/account/enable', 'sig:account:enable', '2', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('107', '102', '账号登录', '/signature/account/login', 'sig:account:login', '2', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('108', '102', '发送验证码', '/signature/account/smscode', 'sig:account:smscode', '2', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('109', '0', '首页设置', '', '', '0', 'fa fa-toggle-off', '3', null, null);
INSERT INTO `sys_menu` VALUES ('110', '109', '客服联系', '/system/contact', 'system:contact', '1', 'fa fa-commenting', null, null, null);
INSERT INTO `sys_menu` VALUES ('111', '0', '报表记录', '', '', '0', 'fa fa-bar-chart-o', '2', null, null);
INSERT INTO `sys_menu` VALUES ('112', '111', '消费记录', '/system/purchase_history', 'system:form_and_logs:purchase_history:list', '1', 'fa fa-bar-chart-o', null, null, null);
INSERT INTO `sys_menu` VALUES ('113', '111', '下载记录', '/system/downloadlog', 'system:form_and_logs:download_log:list', '1', 'fa fa-bars', null, null, null);
INSERT INTO `sys_menu` VALUES ('114', '113', '列表', '/system/downloadlog/list', 'system:form_and_logs:download_log:list', '2', '', '1', null, null);
INSERT INTO `sys_menu` VALUES ('115', '112', '列表', '/system/purchase_history/list', 'system:form_and_logs:purchase_history:list', '2', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('116', '111', '充值记录', '/system/order/user', 'system:order:userorder', '1', 'fa fa-bars', '3', null, null);
INSERT INTO `sys_menu` VALUES ('117', '116', '列表', '/system/order/user/list', 'system:order:userorder', '2', 'fa fa-bars', '1', null, null);
INSERT INTO `sys_menu` VALUES ('118', '0', '客户充值订单', '', '', '0', 'fa fa-bars', '5', null, null);
INSERT INTO `sys_menu` VALUES ('119', '118', '列表', '/system/order', 'system:order:order', '1', 'fa fa-barcode', '1', null, null);
INSERT INTO `sys_menu` VALUES ('120', '119', '列表', '/system/order/list', 'system:order:order', '2', '', '1', null, null);
INSERT INTO `sys_menu` VALUES ('121', '0', '个人中心', '', '', '0', 'fa fa-user-circle', '1', null, null);
INSERT INTO `sys_menu` VALUES ('122', '121', '应用列表', 'index_v1.html', '', '1', 'fa fa-cubes', '0', null, null);
INSERT INTO `sys_menu` VALUES ('123', '0', '客户应用列表', '', '', '0', 'fa fa-barcode', null, null, null);
INSERT INTO `sys_menu` VALUES ('124', '123', '列表', '/signature/app/all/list', 'signature:app:listall', '1', 'fa fa-bar-chart-o', null, null, null);
INSERT INTO `sys_menu` VALUES ('125', '124', '列表', '/signature/app/all/list', 'signature:app:listall', '2', 'fa fa-binoculars', null, null, null);
...
INSERT INTO `sys_role` VALUES ('59', '普通用户', 'general', '基本用户权限', '2', '2019-08-09 11:16:24', '2019-08-09 11:16:28');
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4584 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
...
INSERT INTO `sys_role_menu` VALUES ('4516', '1', '122');
INSERT INTO `sys_role_menu` VALUES ('4517', '1', '120');
INSERT INTO `sys_role_menu` VALUES ('4518', '1', '117');
INSERT INTO `sys_role_menu` VALUES ('4519', '1', '114');
INSERT INTO `sys_role_menu` VALUES ('4520', '1', '115');
INSERT INTO `sys_role_menu` VALUES ('4521', '1', '110');
INSERT INTO `sys_role_menu` VALUES ('4522', '1', '108');
INSERT INTO `sys_role_menu` VALUES ('4523', '1', '107');
INSERT INTO `sys_role_menu` VALUES ('4524', '1', '106');
INSERT INTO `sys_role_menu` VALUES ('4525', '1', '105');
INSERT INTO `sys_role_menu` VALUES ('4526', '1', '104');
INSERT INTO `sys_role_menu` VALUES ('4527', '1', '103');
INSERT INTO `sys_role_menu` VALUES ('4528', '1', '101');
INSERT INTO `sys_role_menu` VALUES ('4529', '1', '100');
INSERT INTO `sys_role_menu` VALUES ('4530', '1', '98');
INSERT INTO `sys_role_menu` VALUES ('4531', '1', '92');
INSERT INTO `sys_role_menu` VALUES ('4532', '1', '57');
INSERT INTO `sys_role_menu` VALUES ('4533', '1', '30');
INSERT INTO `sys_role_menu` VALUES ('4534', '1', '29');
INSERT INTO `sys_role_menu` VALUES ('4535', '1', '28');
INSERT INTO `sys_role_menu` VALUES ('4536', '1', '48');
INSERT INTO `sys_role_menu` VALUES ('4537', '1', '76');
INSERT INTO `sys_role_menu` VALUES ('4538', '1', '75');
INSERT INTO `sys_role_menu` VALUES ('4539', '1', '74');
INSERT INTO `sys_role_menu` VALUES ('4540', '1', '62');
INSERT INTO `sys_role_menu` VALUES ('4541', '1', '56');
INSERT INTO `sys_role_menu` VALUES ('4542', '1', '55');
INSERT INTO `sys_role_menu` VALUES ('4543', '1', '15');
INSERT INTO `sys_role_menu` VALUES ('4544', '1', '26');
INSERT INTO `sys_role_menu` VALUES ('4545', '1', '25');
INSERT INTO `sys_role_menu` VALUES ('4546', '1', '24');
INSERT INTO `sys_role_menu` VALUES ('4547', '1', '14');
INSERT INTO `sys_role_menu` VALUES ('4548', '1', '13');
INSERT INTO `sys_role_menu` VALUES ('4549', '1', '12');
INSERT INTO `sys_role_menu` VALUES ('4550', '1', '61');
INSERT INTO `sys_role_menu` VALUES ('4551', '1', '22');
INSERT INTO `sys_role_menu` VALUES ('4552', '1', '21');
INSERT INTO `sys_role_menu` VALUES ('4553', '1', '20');
INSERT INTO `sys_role_menu` VALUES ('4554', '1', '83');
INSERT INTO `sys_role_menu` VALUES ('4555', '1', '81');
INSERT INTO `sys_role_menu` VALUES ('4556', '1', '80');
INSERT INTO `sys_role_menu` VALUES ('4557', '1', '79');
INSERT INTO `sys_role_menu` VALUES ('4558', '1', '71');
INSERT INTO `sys_role_menu` VALUES ('4559', '1', '121');
INSERT INTO `sys_role_menu` VALUES ('4560', '1', '119');
INSERT INTO `sys_role_menu` VALUES ('4561', '1', '118');
INSERT INTO `sys_role_menu` VALUES ('4562', '1', '116');
INSERT INTO `sys_role_menu` VALUES ('4563', '1', '113');
INSERT INTO `sys_role_menu` VALUES ('4564', '1', '112');
INSERT INTO `sys_role_menu` VALUES ('4565', '1', '111');
INSERT INTO `sys_role_menu` VALUES ('4566', '1', '109');
INSERT INTO `sys_role_menu` VALUES ('4567', '1', '102');
INSERT INTO `sys_role_menu` VALUES ('4568', '1', '99');
INSERT INTO `sys_role_menu` VALUES ('4569', '1', '97');
INSERT INTO `sys_role_menu` VALUES ('4570', '1', '27');
INSERT INTO `sys_role_menu` VALUES ('4571', '1', '91');
INSERT INTO `sys_role_menu` VALUES ('4572', '1', '77');
INSERT INTO `sys_role_menu` VALUES ('4573', '1', '73');
INSERT INTO `sys_role_menu` VALUES ('4574', '1', '7');
INSERT INTO `sys_role_menu` VALUES ('4575', '1', '6');
INSERT INTO `sys_role_menu` VALUES ('4576', '1', '2');
INSERT INTO `sys_role_menu` VALUES ('4577', '1', '3');
INSERT INTO `sys_role_menu` VALUES ('4578', '1', '78');
INSERT INTO `sys_role_menu` VALUES ('4579', '1', '1');
INSERT INTO `sys_role_menu` VALUES ('4580', '1', '125');
INSERT INTO `sys_role_menu` VALUES ('4581', '1', '124');
INSERT INTO `sys_role_menu` VALUES ('4582', '1', '123');
INSERT INTO `sys_role_menu` VALUES ('4583', '1', '-1');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '超级管理员', '1dc189b33f3c72ef7b1fad32c9199610', '6', 'admin@example.com', '17699999999', '1', '1', '2017-08-15 21:40:39', '2017-08-15 21:41:00', '96', '2017-12-14 00:00:00', '138', 'ccc', '122;121;', '北京市', '北京市市辖区', '东城区');
INSERT INTO `sys_user` VALUES ('2', 'dev', '开发测试', '1ce0e142e8ca6041f79248e305a2002a', '13', 'zmxzmz@qq.com', null, '1', null, null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `sys_user_role` VALUES ('136', '2', '59');
INSERT INTO `sys_user_role` VALUES ('137', '4', '59');
INSERT INTO `sys_user_role` VALUES ('138', '5', '59');
INSERT INTO `sys_user_role` VALUES ('139', '6', '59');
INSERT INTO `sys_user_role` VALUES ('140', '7', '59');
INSERT INTO `sys_user_role` VALUES ('141', '8', '59');
INSERT INTO `sys_user_role` VALUES ('142', '9', '59');
INSERT INTO `sys_user_role` VALUES ('143', '10', '59');
INSERT INTO `sys_user_role` VALUES ('144', '11', '59');
INSERT INTO `sys_user_role` VALUES ('145', '12', '59');
INSERT INTO `sys_user_role` VALUES ('146', '13', '59');
INSERT INTO `sys_user_role` VALUES ('147', '14', '59');
INSERT INTO `sys_user_role` VALUES ('148', '15', '59');
INSERT INTO `sys_user_role` VALUES ('155', '22', '59');
INSERT INTO `sys_user_role` VALUES ('156', '23', '59');
INSERT INTO `sys_user_role` VALUES ('157', '24', '59');

-- ----------------------------
-- Table structure for unique_identification_log
-- ----------------------------
DROP TABLE IF EXISTS `unique_identification_log`;
CREATE TABLE `unique_identification_log` (
...
-- ----------------------------
-- Records of unique_identification_log
-- ----------------------------
...
CREATE TABLE `visit_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2909 DEFAULT CHARSET=utf8mb4;
